        ...
        <div className="main-categories">
            ...
            <ul className="flex clean-list categories-list">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Graphics-Design" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Digital-Marketing" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Writing-Translation" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Video-Animation" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Music-Audio" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Programming-Tech" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Business" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Lifestyle" target="_blank">
                ...
                <li className="categories-list-item">
                    <a className="categories-link" href="/explore/Data" target="_blank">
