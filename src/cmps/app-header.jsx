...
export function AppHeader() {
  ...
  { (searchParams.get('nav') === "home") ? console.log("home") : console.log("somewherelse") }
  ...
  return (
    ...
    <header className={(searchParams.get('nav') !== "home") ? "app-header header-white" : (offset > 0) ? "app-header header-white" : "app-header"}>
