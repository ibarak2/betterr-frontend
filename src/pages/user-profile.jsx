export const UserProfile = () => {
  ...
  return (
    <div className="flex user-profile">
      <section className="user-info-column">
        <div className="user-info"></div>
      </section>

      <section className="seller-gigs-column">
        <div className="seller-gigs">
          <ul className="seller-gigs-status">
            <li className="seller-gigs-filter">ACTIVE GIGS</li>
            <li className="seller-gigs-filter">DRAFTS</li>
          </ul>
        </div>
        ...
        <div class="gig-card-base seller-gig-card">
          <span>
              ...
              <a href="/user/gig-title">
                <div>
                  <figure class="no-image">
                    <img src="https://res.cloudinary.com/dalkffrhf/image/upload/v1663602969/Fiverr-Sprint-4/imgs/gig%20img/1_fi4kgs.png" alt="" />
                  </figure>
                </div>
                <h3>I will never gonna give you up</h3>
              </a>
            </div>
            <a href="#!" class="btn-gig-menu hint--top" data-hint="Gig Actions">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="10"
            ...
            <a href="/zrizony/never-gonna-give-you-up" class="gig-price">
        ...
        <a
          class="gig-card-base add-new-gig"
